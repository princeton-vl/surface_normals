...
require('../criterion/relative_depth_margin_log_negative_cos_multi_res')
function get_criterion()
    return nn.relative_depth_margin_log_negative_cos_multi_res(g_args.w_n, g_args.margin, g_args.n_scale)
end
