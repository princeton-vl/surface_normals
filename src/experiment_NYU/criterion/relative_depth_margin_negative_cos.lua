...
local relative_depth_negative_cos, parent = torch.class('nn.relative_depth_negative_cos', 'nn.Criterion')

function relative_depth_negative_cos:__init(w_normal, margin)
