...
local relative_depth_margin_normal_depth, parent = torch.class('nn.relative_depth_margin_normal_depth', 'nn.Criterion')
...
function relative_depth_margin_normal_depth:__init(w_normal, margin)
    print(string.format(">>>>>>>>>>>>>>>>>>>>>>Criterion: relative_depth_margin_normal_depth()  w_normal:%f, margin:%f", w_normal, margin))
    parent.__init(self)
...
function relative_depth_margin_normal_depth:updateOutput(input, target)
...
function relative_depth_margin_normal_depth:updateGradInput(input, target)
