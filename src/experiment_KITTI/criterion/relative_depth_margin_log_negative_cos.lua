...
local relative_depth_margin_log_negative_cos, parent = torch.class('nn.relative_depth_margin_log_negative_cos', 'nn.Criterion')

function relative_depth_margin_log_negative_cos:__init(w_normal, margin)
...
function relative_depth_margin_log_negative_cos:updateOutput(input, target)
...
function relative_depth_margin_log_negative_cos:updateGradInput(input, target)
    -- the input is tensor taht represents the depth map
    -- the target is a table, where the first component is a table that contains relative depth info, and the second component is a table that contains normal info.
